...
class ShadedObject3D extends Object3D { 
    ...
    render( gl )
    {
        ...
        if (this.material.hasMapKD()) {
            ...
            gl.bindTexture(gl.TEXTURE_2D, this.material.map_kD.texture);
            this.shader.setUniform1i('u_material.map_kD', 0);

            this.shader.setUniform1i('u_has_texture', 1);
        }

        if (this.material.hasMapNS()) {
            // TODO
            gl.activeTexture(gl.TEXTURE1);
            gl.bindTexture(gl.TEXTURE_2D, this.material.map_nS.texture);
        ...
        if (this.material.hasMapNorm()) {
            ...
            gl.bindTexture(gl.TEXTURE_2D, this.material.map_norm.texture);
